...
<!-- BEGIN PAGE HEADER-->
<h3 class="page-title">
    Student level 0 management <small></small>
</h3>
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="#">level 0 Customers management</a>
            <i class="fa fa-angle-right"></i>
        </li>
        <li>
            <a href="#">List</a>
    ...
    <div class="col-md-12">
        ...
        <div class="portlet box blue">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-edit"></i>LEVEL 0 STUDENT LIST
                </div>
                <div class="tools">
            ...
            <div class="portlet-body">
                <div class="table-toolbar">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="btn-group">
                                <button id="sample_editable_1_new" class="btn green" data-toggle="modal" data-target="#addLevel0StudentModal">
                            ...
                            <div class="btn-group">
                                <button id="" class="btn yellow" data-toggle="modal" data-target="#UpgradePotentialClassModal">
                                    Upgrade
                                </button>
                            </div>
                        </div>
                            ...
                            <td>
                                <ul class="list-group">
                                    <li class="list-group-item list-group-item-success">
                                        <a class="btn btn-icon-only green" data-toggle="modal" data-target="#updateTestResultModal">
